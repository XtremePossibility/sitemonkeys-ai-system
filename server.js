...
app.post('/api/chat', async (req, res) => {
  try {
    ...
    console.log('🔍 DEBUG - vaultContent after processing:', vaultContent ? `${vaultContent.length} characters` : 'NULL/EMPTY');
console.log('🔍 DEBUG - vaultHealthy:', vaultHealthy);
console.log('🔍 DEBUG - vaultStatus:', vaultStatus);
